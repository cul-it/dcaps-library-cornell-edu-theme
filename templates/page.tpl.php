...
?>
      ...
      <?php print theme('links__system_secondary_menu', array('links' => $secondary_menu, 'attributes' => array('id' => 'secondary-menu', 'class' => array('links', 'inline', 'clearfix', render('$menuParent['title']')), 'heading' => NULL)); ?>
        <?php print $sidebar; ?>
      </div>
